...
<link rel="stylesheet"
	href="/tracker/resources/css/font-awesome.min.css" />
...
<link rel="stylesheet"
	href="/tracker/resources/css/jquery-ui/jquery-ui.css" />
...
<script>
	...
	/* .CSSTableGenerator tr:first-child:hover td {
		background: -o-linear-gradient(bottom, #005fbf 5%, #E8E8E8 100%);
		background: -webkit-gradient(linear, left top, left bottom, color-stop(0.05, #005fbf
			), color-stop(1, #E8E8E8));
		background: -moz-linear-gradient(center top, #005fbf 5%, #E8E8E8 100%);
		filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#005fbf",
			endColorstr="#E8E8E8");
		background: -o-linear-gradient(top, #005fbf, E8E8E8);
		...
		<nav class="navbar navbar-fixed-top" role="banner">
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-right">
					<c:choose>
						<c:when
							test="${ sessionScope.loginuser ne null && sessionScope.loginuser.active eq 'user'}">
							<ul class="nav navbar-nav">
								<li>${ loginuser.id }님환영합니다. <a
									href="/tracker/account/logout.action">로그아웃</a></li>
						...
						<c:when
							test="${ sessionScope.loginuser ne null && sessionScope.loginuser.active eq 'admin'}">
							<ul class="nav navbar-nav">
								<li>${ loginuser.id }님환영합니다. <a
									href="/tracker/account/logout.action">로그아웃</a></li>
								<li><a id="button_open_dialog">1:1 상담</a></li>
